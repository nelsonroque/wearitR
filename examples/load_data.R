...
beep_survey1 = wearitR::read_wearit_surveydata("examples/data/1035_Beeped_Survey_1_2022-01-19.csv")
View(beep_survey1$keytable)
View(beep_survey1$clean_data)

beep_survey2 = wearitR::read_wearit_surveydata("examples/data/1035_Beeped_Survey_2_2022-01-19.csv")
